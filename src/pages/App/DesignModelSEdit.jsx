    ...
    <>
      ...
      <div className='design-page'>
        ...
        <div className="design-select">
          <p>Cybertruck</p>
          <p>Model 3</p>
          <Link to={`/models/design/${ params.id }`}><p id="selected-design">Model S</p></Link>
          <p>Roadster</p>
        </div>
        ...
        <div className="design-controls">
          ...
          <div className="options-motor">
              ...
              <div onClick={ () => { setDesign({ ...design, motor_options: "Dual Motor" }) } } className="motor-option-1" id={ design.motor_options === "Dual Motor" ? "option-selected" : "" }><p>Model S</p><p>$96,590</p></div>
              <p>Tri Motor All-Wheel Drive</p>
              <div onClick={ () => { setDesign({ ...design, motor_options: "Tri Motor" }) } } className="motor-option-2" id={ design.motor_options === "Tri Motor" ? "option-selected" : ""  }><p>Model S Plaid</p><p>$127,590</p></div>
            </div>  
          </div>
          <div className="options">
